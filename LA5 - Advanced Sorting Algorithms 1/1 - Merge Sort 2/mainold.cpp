...
//     node* curr = list->getHead(); // to iterate
//     node* middle = list->split(list);
    
//     // first half
//     for( ; curr != middle; curr = curr->next){
//         // firsthalf->element = curr->element; // add the element; wrong
...
//         // secondhalf->element = curr->element; // add the element; wrong
...
//     // check this 
//     node* first = firsthalf->getHead(); // first
//     node* second = secondhalf->getHead(); // second
    
//     // problem: ...half->element -- get the value
//     while(first && second){
//         if(first->element < second->element){
//             sorted->add(first->element);
//             first = first->next;
//         }else{
//             sorted->add(second->element);
//             second = second->next;
//         }
//     }
...
//     //         sorted->add(firsthalf->element);
//     //         firsthalf = firsthalf->next;
//     //     }else{
//     //         sorted->add(secondhalf->element);
//     //         secondhalf = secondhalf->next;
//     //     }
//     // }
